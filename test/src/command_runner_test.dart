...
import 'package:demo_cli_dart/src/command_runner.dart';
...
void main() {
  group('DemoCliDartCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late DemoCliDartCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = DemoCliDartCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = DemoCliDartCommandRunner();
